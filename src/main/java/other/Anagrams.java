...
public class Anagrams {
    public List<List<String>> groupAnagrams(String[] strs) {
        ...
        //1. take a hashmap and store key as string and values in arraylist

        //2. then iterate for each strs
        //3. Convert particular word in toCharArray

        //4. then sort them

        //5. check if does not contian in map then put it into map
        //if map does contian same sorted word then only increase size at that
        // particular word it will mean that if 3 is count for one word then in that
        // list 3 word related to it will contian in list
